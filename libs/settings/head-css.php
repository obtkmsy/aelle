...
<?php elseif (is_page() || is_singular('form') || is_404()):?>
...
<?php endif;?> 
<?php if (is_singular('download') || is_singular('article') ||  is_singular('service')):?>
<link rel="stylesheet" href="<?php echo tmpdir(); ?>/css/single.css">
<?php endif;?>
